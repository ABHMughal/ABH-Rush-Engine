...
else if (action == consPlayerActionJump || action == consPlayerActionRoll || action == consPlayerActionSpinning3  || action == consPlayerActionAutoTunnel) //&& sprp != spr_SuperSonic_land
{
